...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="header">
            <div class="header-menu">
                ...
                <ul>
                    ...
                    <li><a href="showrequest.php?user_id=<?php echo $user['id']; ?>"><i
        ...
        <div class="sidebar">
            ...
            <li class="item">
                <a href="activity_log1.php?user_id=<?php echo $user['id']; ?>" class="menu-btn">
                    <i class="fab fa-autoprefixer"></i><span>Activity Log</span>
                </a>
            </li>
            <li class="item">
                <a href="user_log1.php?user_id=<?php echo $user['id']; ?>" class="menu-btn">
    ...
    <div class="container">
        ...
        <!-- <div class="feed">
            <a href="http://localhost:5000/" target="blank">click here to view feedback results</a>
        </div> -->
